...
final class TraitHelpers {
    ...
    static void serialize_vector_AccountAddress(java.util.List<dev.aptos.types.AccountAddress> value, com.novi.serde.Serializer serializer) throws com.novi.serde.SerializationError {
        serializer.serialize_len(value.size());
        for (dev.aptos.types.AccountAddress item : value) {
            item.serialize(serializer);
        }
    }

    static java.util.List<dev.aptos.types.AccountAddress> deserialize_vector_AccountAddress(com.novi.serde.Deserializer deserializer) throws com.novi.serde.DeserializationError {
        long length = deserializer.deserialize_len();
        java.util.List<dev.aptos.types.AccountAddress> obj = new java.util.ArrayList<dev.aptos.types.AccountAddress>((int) length);
