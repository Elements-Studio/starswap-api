...
public abstract class TransactionPayload {
    ...
    public static final class Script extends TransactionPayload {
        public final dev.aptos.types.Script value;

        public Script(dev.aptos.types.Script value) {
        ...
        static Script load(com.novi.serde.Deserializer deserializer) throws com.novi.serde.DeserializationError {
            ...
            builder.value = dev.aptos.types.Script.deserialize(deserializer);
        ...
        public static final class Builder {
            public dev.aptos.types.Script value;
    ...
    public static final class ModuleBundle extends TransactionPayload {
        public final dev.aptos.types.ModuleBundle value;

        public ModuleBundle(dev.aptos.types.ModuleBundle value) {
            java.util.Objects.requireNonNull(value, "value must not be null");
            this.value = value;
        }
        ...
        static ModuleBundle load(com.novi.serde.Deserializer deserializer) throws com.novi.serde.DeserializationError {
            deserializer.increase_container_depth();
            Builder builder = new Builder();
            builder.value = dev.aptos.types.ModuleBundle.deserialize(deserializer);
            deserializer.decrease_container_depth();
            return builder.build();
        }
        ...
        public static final class Builder {
            public dev.aptos.types.ModuleBundle value;
    ...
    public static final class EntryFunction extends TransactionPayload {
        public final dev.aptos.types.EntryFunction value;

        public EntryFunction(dev.aptos.types.EntryFunction value) {
            java.util.Objects.requireNonNull(value, "value must not be null");
            this.value = value;
        }
        ...
        static EntryFunction load(com.novi.serde.Deserializer deserializer) throws com.novi.serde.DeserializationError {
            deserializer.increase_container_depth();
            Builder builder = new Builder();
            builder.value = dev.aptos.types.EntryFunction.deserialize(deserializer);
            deserializer.decrease_container_depth();
            return builder.build();
        }
        ...
        public static final class Builder {
            public dev.aptos.types.EntryFunction value;
