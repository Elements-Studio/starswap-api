...
public final class ModuleBundle {
    public final dev.aptos.types.AccountAddress package_address;
    public final java.util.List<dev.aptos.types.Module> modules;
    public final java.util.Optional<EntryFunction> init_script;

    public ModuleBundle(dev.aptos.types.AccountAddress package_address, java.util.List<dev.aptos.types.Module> modules, java.util.Optional<EntryFunction> init_script) {
    ...
    public static ModuleBundle deserialize(com.novi.serde.Deserializer deserializer) throws com.novi.serde.DeserializationError {
        ...
        builder.package_address = dev.aptos.types.AccountAddress.deserialize(deserializer);
        builder.modules = dev.aptos.types.TraitHelpers.deserialize_vector_Module(deserializer);
        builder.init_script = dev.aptos.types.TraitHelpers.deserialize_option_ScriptFunction(deserializer);
    ...
    public void serialize(com.novi.serde.Serializer serializer) throws com.novi.serde.SerializationError {
        ...
        dev.aptos.types.TraitHelpers.serialize_vector_Module(modules, serializer);
        dev.aptos.types.TraitHelpers.serialize_option_ScriptFunction(init_script, serializer);
