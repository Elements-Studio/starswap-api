...
public final class UnBoostEvent {
    ...
    public UnBoostEvent(TokenCode x_token_code, TokenCode y_token_code, AccountAddress signer, java.math.@com.novi.serde.Unsigned @com.novi.serde.Int128 BigInteger amount) {
    ...
    public static UnBoostEvent deserialize(com.novi.serde.Deserializer deserializer) throws com.novi.serde.DeserializationError {
    ...
    public static UnBoostEvent bcsDeserialize(byte[] input) throws com.novi.serde.DeserializationError {
        if (input == null) {
             throw new com.novi.serde.DeserializationError("Cannot deserialize null array");
        }
        com.novi.serde.Deserializer deserializer = new com.novi.bcs.BcsDeserializer(input);
        UnBoostEvent value = deserialize(deserializer);
    ...
    public boolean equals(Object obj) {
        ...
        UnBoostEvent other = (UnBoostEvent) obj;
    ...
    public static final class Builder {
        ...
        public UnBoostEvent build() {
            return new UnBoostEvent(
                x_token_code,
                y_token_code,
                signer,
                amount
